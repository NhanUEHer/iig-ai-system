...
function ensureFormAccess(current,auth,write=false) {
  ...
  if(!['reports.entry','reports.manage'].some(key=>auth.permissions?.includes(key))||String(current.assigned_user_id||'')!==String(auth.userId||''))
