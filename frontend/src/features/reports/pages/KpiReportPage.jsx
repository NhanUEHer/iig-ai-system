...
const DETAIL_LABELS = {
  ...
  channel_name:'Kênh',followers_current:'Followers kỳ này',followers_previous:'Followers kỳ trước',followers_growth:'Tăng trưởng Followers',reach_current:'Reach kỳ này',reach_previous:'Reach kỳ trước',reach_growth:'% vs TTr Reach',organic_reach:'Organic Reach',organic_rate:'Tỷ lệ Organic',video_views:'View Video',engagement_count:'Lượt tương tác',engagement_rate:'Engagement Rate',
  organization_name:'Trường / Đơn vị',organization_type:'Loại trường',region:'Vùng miền',activity_date_text:'Ngày triển khai',activity_days:'Số ngày',workshop_count:'Workshop',social_post_count:'Bài Social',is_new_contract:'Ký mới',reach:'Reach',budget:'Ngân sách',
  course_name:'Khóa học',started_class_count:'Lớp khai giảng',class_count:'Lớp đang đào tạo',completed_class_count:'Lớp bế giảng',active_student_count:'HV đang đào tạo',student_target:'KH HV đang đào tạo',student_achievement:'% HT KH',new_student_count:'HV mới',completed_student_count:'HV kết thúc',evaluated_student_count:'HV được đánh giá',qualified_student_count:'HV đạt đầu ra',teacher_count:'GV theo khóa',output_rate:'Tỷ lệ đạt đầu ra',upsell_revenue:'Doanh thu học lên',status:'Tình trạng',
  activity_name:'Tên sản phẩm / hoạt động',activity_type:'Loại hoạt động',kpi_code:'KPI đóng góp',target_quantity:'KH số lượng',actual_quantity:'TH số lượng',contribution_value:'Giá trị KPI',progress_percent:'% tiến độ',owner_unit:'Đơn vị phụ trách',cooperating_unit:'Đơn vị phối hợp',next_action:'Kế hoạch kỳ',progress_status:'Tiến độ',planned_end_date:'Hạn hoàn thành',actual_end_date:'Ngày hoàn thành',output_url:'Link tài liệu',implementation_result:'Kết quả thực hiện',note:'Ghi chú'
};
const DETAIL_COLUMNS={
  ...
  COM:['channel_name','followers_current','followers_previous','followers_growth','reach_current','reach_previous','reach_growth','organic_reach','organic_rate','video_views','engagement_count','engagement_rate','lead_count','budget','revenue','note'],
  TRADE:['organization_name','organization_type','region','activity_type','is_new_contract','activity_date_text','activity_days','workshop_count','social_post_count','reach','lead_count','budget','revenue','note'],
  TRAIN:['course_name','started_class_count','class_count','completed_class_count','active_student_count','student_target','student_achievement','new_student_count','completed_student_count','evaluated_student_count','qualified_student_count','output_rate','teacher_count','upsell_revenue','status','note'],
...
const PERCENT_DETAIL_KEYS=new Set(['revenue_share','achievement_rate','previous_change','prior_year_change','followers_growth','reach_growth','organic_rate','engagement_rate','student_achievement','output_rate']);
const NUMBER_DETAIL_KEYS=new Set(['order_count','revenue','monthly_target','previous_revenue','prior_year_revenue','budget_target','budget_actual','lead_count','qualified_lead_count','ad_cost','followers_current','followers_previous','reach_current','reach_previous','organic_reach','video_views','engagement_count','activity_days','workshop_count','social_post_count','reach','budget','started_class_count','class_count','completed_class_count','active_student_count','student_target','new_student_count','completed_student_count','evaluated_student_count','teacher_count','upsell_revenue','target_quantity','actual_quantity','contribution_value','progress_percent']);
const DATE_DETAIL_KEYS=new Set(['planned_end_date','actual_end_date']);
